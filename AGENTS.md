...
- Toda classificação de determinismo declara sua origem. `NOT_APPLICABLE` não pode nascer apenas de análise do modelo; um default mecânico só pode ser aplicado quando citar uma regra arquitetural confiável que o autorize.
