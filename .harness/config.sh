...
: "${AEGIS_RAW_SUBSTRATE_MAX_TOKENS_OPTIMIZE:=768}"
: "${AEGIS_RAW_SUBSTRATE_MAX_TOKENS_ADVERSARIAL:=1024}"
: "${AEGIS_RAW_SUBSTRATE_MAX_TOKENS_VALIDATION:=512}"

# Adversarial review intensity depth: low | medium | paranoid (default: medium)
: "${AEGIS_ADVERSARIAL_DEPTH:=medium}"
