...
# authorizes for Forensics build candidates.
#
...
validate_validation_artifact() {
  ...
  # Adversarial leaves candidate_result + findings (may be empty array).
...
readonly AEGIS_JQ_ENRICH_OPTIMIZE='
  ...
  | (
      [
        ...
        # P1: reject vague / too-short change lines (Build cannot act).
