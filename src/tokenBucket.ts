export class TokenBucket {
  ...
  constructor(maxBytes: bigint, mbps: number, initialTimeMs: bigint) {
    ...
    this._lastUpdateMs = initialTimeMs !== undefined ? initialTimeMs : BigInt(Date.now());
  }
