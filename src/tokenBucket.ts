type TokenBucketState = { tokens: bigint; maxTokens: bigint; rateBitsPerMs: bigint; isRefillActive: boolean; };
...
export class TokenBucket {
  ...
  getState(): TokenBucketState {
    ...
    rateBitsPerMs: this._rateBitsPerMs,
    isRefillActive: this._rateBitsPerMs > 0n
    };
  }
